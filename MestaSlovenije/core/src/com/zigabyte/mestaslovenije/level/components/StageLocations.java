...
public class StageLocations {
	...
	public static StageLocations mesta1 = new StageLocations("Veèja mesta ", "mesta1.txt");
	public static StageLocations mesta2 = new StageLocations("Mesta", "mesta2.txt");
	public static StageLocations mesta3 = new StageLocations("Manjša mesta", "mesta3.txt");
	public static StageLocations mesta4 = new StageLocations("Manjša mesta drugiè", "mesta4.txt");
