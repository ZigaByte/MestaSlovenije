...
public class Render {
	...
	public Render() {
		...
		fonts[128] = new BitmapFont(Gdx.files.internal("fonts/font128.fnt"));
	...
	public void drawText(String text, Color color, float x, float y, int size) {
		...
		final float offsetX = -layout.width / 2;
		final float offsetY = layout.height / 2;

		Color c = new Color(color);
		c.sub(0, 0, 0, 0.5f);
		font.setColor(c);
		font.draw(spriteBatch, text, x + offsetX, y + offsetY);
	}
